...
export function SaveHeaders(arg1:string,arg2:string,arg3:Array<thrift.StateProjectFormHeader>):Promise<thrift.State|Error>;
...
export function AddHeader(arg1:string,arg2:string):Promise<thrift.State|Error>;

export function CreateNewProject(arg1:string):Promise<thrift.State|Error>;

export function DeleteHeader(arg1:string,arg2:string,arg3:string):Promise<thrift.State|Error>;
